...
const (
	...
	TSSService_StartSign_FullMethodName   = "/tss.TSSService/StartSign"
)
...
type TSSServiceClient interface {
	...
	StartSign(ctx context.Context, in *SignRequest, opts ...grpc.CallOption) (*SignResponse, error)
}
...
func (c *tSSServiceClient) StartSign(ctx context.Context, in *SignRequest, opts ...grpc.CallOption) (*SignResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SignResponse)
	err := c.cc.Invoke(ctx, TSSService_StartSign_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TSSServiceServer interface {
	...
	StartSign(context.Context, *SignRequest) (*SignResponse, error)
...
func (UnimplementedTSSServiceServer) StartSign(context.Context, *SignRequest) (*SignResponse, error) {
...
func _TSSService_StartSign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SignRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TSSServiceServer).StartSign(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TSSService_StartSign_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TSSServiceServer).StartSign(ctx, req.(*SignRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TSSService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TSSService_StartSign_Handler,
		},
	},
